    ...
    <div className="mt-10 flex flex-wrap items-center gap-6">
      <div className="flex flex-col gap-1 border-l border-white/10 pl-4">
        <span className="font-display text-2xl text-zinc-100 sm:text-3xl">
          {stats.followers === null ? '—' : stats.followers.toLocaleString('fa-IR')}
        </span>
      ...
      <div className="flex flex-col gap-1 border-l border-white/10 pl-4">
        <span className="font-display text-2xl text-zinc-100 sm:text-3xl">
          {stats.repos === null ? '—' : stats.repos.toLocaleString('fa-IR')}
        </span>
      ...
      <div className="flex flex-col gap-1 border-l border-white/10 pl-4">
        <span className="font-display text-2xl text-zinc-100 sm:text-3xl">
          {stats.stars === null ? '—' : stats.stars.toLocaleString('fa-IR')}
        </span>
